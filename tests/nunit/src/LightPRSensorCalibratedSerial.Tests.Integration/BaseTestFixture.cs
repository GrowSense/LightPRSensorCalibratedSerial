...
namespace LightPRSensorCalibratedSerial.Tests.Integration
{
    public class BaseTestFixture
    {
        ...
        {
            var devicePort = Environment.GetEnvironmentVariable ("LIGHT_PR_MONITOR_PORT");
        ...
        {
            var simulatorPort = Environment.GetEnvironmentVariable ("LIGHT_PR_MONITOR_SIMULATOR_PORT");
