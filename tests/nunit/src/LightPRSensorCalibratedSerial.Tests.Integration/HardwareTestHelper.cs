...
namespace LightPRSensorCalibratedSerial.Tests.Integration
{
  public class HardwareTestHelper : IDisposable
  {
    ...
    public string DeviceStartText = "Starting light (photoresistor) monitor";
    ...
    {
      Assert.IsTrue (dataEntry.ContainsKey (dataKey), "The key '" + dataKey + "' was not found in the data entry.");
